    ...
    <div class="pure-g-r">
        ...
        <div class="pure-u-1 menubar">
            <ul class="primary">
                ...
                <li><a href="http://gestaourbana.prefeitura.sp.gov.br/arquivos/mapas/mapas.zip"><i class="icon-map"></i> mapas</a></li>
                <li><a href="http://gestaourbana.prefeitura.sp.gov.br/arquivos/quadros/quadros_preliminar.zip"><i class="icon-quadro"></i> quadros</a></li>
            </ul>
            <ul class="secondary">
